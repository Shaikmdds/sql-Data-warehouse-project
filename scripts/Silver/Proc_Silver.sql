...
Script Purpose:
This stored procedure loads data into the 'silver' schema silver layer tables. It performs the following actions:
-
...
declare @start_time datetime, @end_time datetime, @start_batch_time datetime, @end_batch_time datetime
	begin try
		...
		select  
		  case when cid like 'NASA%' then trim(substring(cid, 4,len(cid)))
			   else cid 
		end as cid,
		...
		case when cntry in ('USA','US','United States') then 'USA'
